...
def test_submission(handin_path, log_file, student_file):
  ...
  try:
    ...
    all_res.q3 = test_res(working_dir, calc, calc_ref, tests_list[0], log_file)
    print("Q4...", file=log_file)
    all_res.q4 = test_res(working_dir, calc, calc_ref, tests_list[1], log_file)
    print("Q5...", file=log_file)
    all_res.q5 = test_res(working_dir, calc, calc_ref, tests_list[2], log_file)
    print("Q6...", file=log_file)
    all_res.q6 = test_res(working_dir, calc, calc_ref, tests_list[3], log_file)
    print("Q8...", file=log_file)
    all_res.q8 = test_res(working_dir, calc, calc_ref, tests_list[4], log_file)
    print("Q9...", file=log_file)
    all_res.q9 = test_res(working_dir, calc, calc_ref, tests_list[5], log_file)
  except Exception as e:
    print(e)
  finally:
