...
def test_walk_sat():
  ...
  print("Testing on a formula with 8 variables and 24 clauses...", end="\t", flush=True)
  ...
  print("Testing on a formula with 27 variables and 111 clauses...", end="\t", flush=True)
...
def display_and_solve(l, prefix="", prop=False):
...
def test_solve_harder():
 ...
 if not display_and_solve(l,"\t",True):
     return
