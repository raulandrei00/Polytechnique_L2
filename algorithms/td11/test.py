...
def read_cities():
    cities=["Barcelona","Belgrade","Berlin","Brussels","Bucharest","Budapest","Copenhagen","Dublin",
            "Hamburg","Istanbul","Kyiv","London","Madrid","Milan","Moscow","Munich","Paris","Prague",
...
def test_trip():
    ...
    cities_in_tour2=set(["Barcelona","Belgrade","Berlin","Brussels","Hamburg","Paris","Istanbul","Kyiv","London","Moscow","Prague","Rome","Saint Petersburg", "Sofia", "Stockholm", "Vienna"])
